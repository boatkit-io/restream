module github.com/boatkit-io/restream/examples/tictactoe
...
require (
	github.com/boatkit-io/tugboat v0.8.9 // indirect
...
tool github.com/boatkit-io/restream/cmd/codegen

replace github.com/boatkit-io/restream => ../../
